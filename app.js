...
function navigateTo(pageName) {
    ...
    fetch(`/webserverapp/pages/${pageName}.php`)
        .then(response => {
            if (!response.ok) {
...
document.addEventListener('click', (event) => {
    ...
    if(url !== "page=search-inscription"){
        document.getElementById("search-inscrit").style.display = "none";
    }else if(url === "page=search-inscription"){
        document.getElementById("search-inscrit").style.display = "block";
    }
    
    if(url === "page=search-paiment"){
        document.getElementById("search-paiment").style.display = "block";
    }else if(url !== "page=search-paiment"){
        document.getElementById("search-paiment").style.display = "none";
    }
});
